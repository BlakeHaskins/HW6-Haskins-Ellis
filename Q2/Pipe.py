...
class Pipe():
    ...
    def __init__(self, Start='A', End='B',L=100, D=200, r=0.00025, fluid=Fluid()):
        ...
        self.Q=0.01 #working in units of m^3/s, just an initial guess
    ...
    def V(self):
        ...
        '''
        self.vel=abs(self.Q)/self.A  # the average velocity is Q/A
        return self.vel
    ...
    def getFlowHeadLoss(self, s):
        ...
        :param s: the node im starting with in a traversal of the pipe
